...
public class Game extends Canvas {
        ...
        private double jump = 50; // vert. yump (px)
    	...
    	public Game() {
    		...
    		JFrame container = new JFrame("Hello pongos");
         ...
         * input: none
         * output: none	
         * purpose: Initialize the starting state of the ship and alien entities.
         *          Each entity will be added to the array of entities in the game.
    	 */
    	private void initEntities() {
              // create the ship and put in center of screen
              ship = new ShipEntity(this, "sprites/ship.gif", 0, 900);
              entities.add(ship);
         ...
         */
         ...
         public void notifyDeath() {
           message = "You dig in the deep ocean!  Try again?";
           waitingForKeyPress = true;
         } // notifyDeath


         /* Notification that the player has killed all aliens
          */
         public void notifyWin(){
           message = "You kicked some ALIEN BUTT!  You zucc!";
           waitingForKeyPress = true;
         } // notifyWin
	...
	private class KeyInputHandler extends KeyAdapter {
		...
		public void keyPressed(KeyEvent e) {
                  ...
                  // respond to move left, right, jump or fire
		...
		public void keyReleased(KeyEvent e) {
                  ...
                  // respond to move left, right, up or fire
                  if (e.getKeyCode() == KeyEvent.VK_LEFT) {
                    leftPressed = false;
                  } // if
